...
| Full chip, GF180MCU (wafer.space) | CI builds both slots (0p5x0p5, 0p5x1); gate-level simulation and the official wafer.space precheck pass | `flow/wafer-space-gf180` |
